...
# Learn a BPE model with 32k merges and reserved symbols for abstract forms
...
# Encode all data
spm_encode --model=$working_dir/spm.model < $data_dir/train.src > $working_dir/train.src
spm_encode --model=$working_dir/spm.model < $data_dir/train.trg > $working_dir/train.trg
